...
public class SQLHelper extends SQLiteOpenHelper {
    ...
    private static final String PARAMETRES= "CREATE TABLE PARAMETRES " +
            "(ID INTEGER PRIMARY KEY, CODEV TEXT, NOM TEXT, PRENOM TEXT, EMAIL TEXT, MYPASSWORD TEXT, URLSERVEUR TEXT)" ;

    private static final String init_PARAMETRES= "INSERT INTO PARAMETRES " +
            "(ID, CODEV, NOM, PRENOM, EMAIL,  URLSERVEUR) VALUES (1,0,' ', ' ','@','https://')";
    /**
     *
     * @param context
     */
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL (PARAMETRES);
    ...
    public boolean update_parametres(Integer codeVisiteur, String nom, String prenom, String email,String MyPassword, String urlServeur)  {
        //on cree une variable de type sqLitedatabase pr pouvoir y acceder
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        ...
        //contentValues.put("MYPASSWORD", MyPassword);

        if (MyPassword.length()>0) {
            contentValues.put(MyPassword, sha1Hash(MyPassword.toString(),codeVisiteur.toString()));
        }
